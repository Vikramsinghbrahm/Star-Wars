    ...
    <body>
        ...
        <div id="main" style="width:100%">
            <div class="col-sm-8" style="float:left; width:50%"> 
                <% 
                    String characterName = String.valueOf(request.getParameter("character")); 
                    PeopleTableGateway pg = new PeopleTableGateway();
                    People character = pg.findCharacterDetailsWithName(characterName);
                %>
